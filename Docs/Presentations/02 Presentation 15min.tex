...
%     \item In average the time required for reaching the \textbf{10\%} advance is 7.25 years and 2 years more for reaching the \textbf{50\%} of advance of the road.
%     \item he concession length had an average of \textbf{191 km}
%     \begin{itemize}
%         \item[i. ] The shortest concession length was \textbf{31km}.
%         \item[ii. ] he largest concession length was \textbf{491 km}.
%     \end{itemize}
%     \item 987  schools (Public 737, Private 250 ) were implicated within a radius of 1000 meters from the road which represents the focus of this research. 
...
\begin{frame}{Comparison}
    \begin{figure}
        \centering
        \includegraphics{Graph/dif-dif-stage.png}
